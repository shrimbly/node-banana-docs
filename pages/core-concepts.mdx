...
| **Nano Banana** | Generate images with AI |
...
- Found on: Image Input, Annotation, Nano Banana, Split Grid, Output
- Color: Blue
...
- Found on: Prompt, LLM Generate, Nano Banana (input)
- Color: Green
