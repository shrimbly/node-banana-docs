...
- 3x2 grid layout option for Split Grid node, with layout-based selector showing 7 distinct grid configurations ([#66](https://github.com/shrimbly/node-banana/pull/66))
