...
- Router node for branching and merging data flow with dynamic input/output handles and multi-type support (image, text, video, audio) ([#87](https://github.com/shrimbly/node-banana/pull/87))
...
- Visual dimming system — disabled Switch/ConditionalSwitch paths dim downstream nodes to 40% opacity; dimmed nodes are skipped during execution ([#87](https://github.com/shrimbly/node-banana/pull/87))
- Gemini Veo 3.1 video generation via native Gemini API (text-to-video and image-to-video, standard and fast variants) ([#87](https://github.com/shrimbly/node-banana/pull/87))
- Anthropic Claude as an LLM provider — Claude Opus 4.6, Sonnet 4.5, and Haiku 4.5 models available in LLM Generate node ([#87](https://github.com/shrimbly/node-banana/pull/87))
