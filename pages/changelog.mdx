...
- 1x5 grid option in Split Grid node ([#51](https://github.com/shrimbly/node-banana/pull/51))
...
- Vercel deployment timeout reduced to 300s for hobby plan compatibility ([#51](https://github.com/shrimbly/node-banana/pull/51))
