...
- Nodes with inline parameters (e.g. model settings panels) no longer accumulate extra height on each workflow reload ([#103](https://github.com/shrimbly/node-banana/pull/103))

### Changed

- ArrayNode auto-route button now displays a split icon instead of a placeholder, making its purpose clearer ([#103](https://github.com/shrimbly/node-banana/pull/103))
