...
| Setting | Description |
|---------|-------------|
| **Model** | Select from Gemini, Anthropic, or OpenAI models |
...
<Callout type="warning">
  OpenAI models require a separate `OPENAI_API_KEY` in your environment. Anthropic models require a separate `ANTHROPIC_API_KEY`.
</Callout>
