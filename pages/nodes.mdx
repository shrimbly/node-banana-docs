...
The Generate Image node creates images using AI models from multiple providers including Gemini, Replicate, fal.ai, and OpenAI.
...
| Setting | Description |
|---------|-------------|
| **Provider** | Choose from Gemini, Replicate, fal.ai, or OpenAI |
...
- **OpenAI** — OpenAI API key (surfaces the GPT Image models)
...
Two GPT Image models are available via the OpenAI provider once an OpenAI API key is configured:

| Model | Capabilities | Parameters |
|-------|--------------|------------|
| **GPT Image 1** | Text-to-image, image-to-image | Size, quality, background |
| **GPT Image 2** | Text-to-image, image-to-image | Size, quality, background |

- **Size** — 1024x1024, 1024x1536, 1536x1024, or auto
- **Quality** — low, medium, high, or auto
- **Background** — transparent, opaque, or auto

See [Models & Pricing](/guides/models-pricing) for cost details.
