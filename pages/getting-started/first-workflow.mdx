...
1. **Model**: Keep "nano-banana" for faster, cheaper generation
2. **Aspect Ratio**: Choose from options like 1:1, 16:9, 4:3, etc.

<Callout type="tip">
  Start with "nano-banana" while testing. Switch to "nano-banana-pro" for higher quality final results.
</Callout>
