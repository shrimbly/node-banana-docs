...
- **OpenAI** — GPT models for text generation in LLM nodes
...
The fastest, lowest-cost model, built on Gemini 3.1 Flash Lite.
...
| **Resolution** | 1K only |
| **Speed** | Fastest |
| **Cost** | $0.034 per image (flat) |
| **Capabilities** | Text-to-image and image-to-image (up to 10 reference images) |
| **Best for** | Rapid iteration and large batches, such as Split Grid workflows |
...
1. **Use nano-banana-2-lite or nano-banana for testing** — Lite is the cheapest at a flat $0.034/image
...
- Model: nano-banana-2-lite (or nano-banana)
- Resolution: 1K
